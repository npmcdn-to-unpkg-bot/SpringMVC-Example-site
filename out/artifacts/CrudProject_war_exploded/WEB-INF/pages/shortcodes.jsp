...
<html>
<head>
    <title>Learn an Education Category Flat Bootstarp Resposive Website Template | Shortcodes :: w3layouts</title>
    ...
    <div class="container">
        <div class="short_code">
            ...
            <div class="but_1">
                ...
                <a class="shortcode_but small" href="#" target="_self"
                   style="color:#ffffff; background-color:#94d64f; ">Click Me</a>
                <a class="shortcode_but small" href="#" target="_self"
                   style="color:#ffffff; background-color:#d6724f; ">Click Me</a>
                <a class="shortcode_but small" href="#" target="_self"
                   style="color:#ffffff; background-color:#d64f78; ">Click Me</a>
                <a class="shortcode_but small" href="#" target="_self"
                   style="color:#ffffff; background-color:#d64f4f; ">Click Me</a>
                <a class="shortcode_but small" href="#" target="_self"
                   style="color:#ffffff; background-color:#4fbed6; ">Click Me</a>
            </div>
            <div class="but_2">
                <h3 class="shortcode_head" style="font-size: 22px;font-weight: normal;">Medium Buttons</h3>
                <a class="shortcode_but medium" href="#" target="_self"
                   style="color:#ffffff; background-color:#94d64f; ">Click Me</a>
                <a class="shortcode_but medium" href="#" target="_self"
                   style="color:#ffffff; background-color:#d6724f; ">Click Me</a>
                <a class="shortcode_but medium" href="#" target="_self"
                   style="color:#ffffff; background-color:#4fbed6; ">Click Me</a>
                <a class="shortcode_but medium" href="#" target="_self"
                   style="color:#ffffff; background-color:#d64f92; ">Click Me</a>
                <a class="shortcode_but medium" href="#" target="_self"
                   style="color:#ffffff; background-color:#4f8ed6; ">Click Me</a>
            </div>
            <div class="but_3">
                <h3 class="shortcode_head" style="font-size: 22px;font-weight: normal;">Large Buttons</h3>
                <a class="shortcode_but large" href="#" target="_self"
                   style="color:#ffffff; background-color:#94d64f; ">Click Me</a>
                <a class="shortcode_but large" href="#" target="_self"
                   style="color:#ffffff; background-color:#d64f78; ">Click Me</a>
                <a class="shortcode_but large" href="#" target="_self"
            ...
            <div class="alert alert-dismissible admission-alert info" role="alert">
                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true"><i
                        class="fa fa-times-circle"></i></span><span class="sr-only">Close</span></button>
                <br>
                ...
                <div class="but_list">
                    ...
                    <div class="col-md-6 page_1">
                        ...
                        <div class="list-group list-group-alternate">
                            ...
                            <a href="#" class="list-group-item"><span class="badge">20</span> <i
                                    class="ti ti-comments"></i> Messages </a>
