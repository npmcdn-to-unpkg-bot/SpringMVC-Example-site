 ...
 * License: MIT
 */
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "datatables"), function (a, b, c, d) {
    "use strict";
        ...
        function g(a) {
            ...
            return function (a, c, f, g) {
                ...
                d.forEach(["dtColumns", "dtColumnDefs", "dtOptions"], function (b) {
                    a[i].call(a, b, h, !0)
                }), e.showLoading(c, a), g.render(c, g.buildOptionsPromise(), b)
            }
        }
    ...
    function l() {
        function a(a) {
            return g.loadingTemplate = a, g
        }

        function b(a) {
            return c.ajax({
                dataType: "json", url: a, success: function (a) {
                    c.extend(!0, c.fn.dataTable.defaults, {oLanguage: a})
                }
            }), g
        }

        function d(a) {
            return c.extend(!0, c.fn.dataTable.defaults, {oLanguage: a}), g
        }

        function e(a) {
            return c.extend(c.fn.dataTable.defaults, {iDisplayLength: a}), g
        }

        function f(a) {
            return g.bootstrapOptions = a, g
        }
    ...
    function o(a, b, c, d) {
        function e(e) {
            function f(b, e) {
                k = b, l = e;
                var f = d.newDTInstance(m), g = c.hideLoadingAndRenderDataTable(b, m.options);
            ...
            function i() {
                j.destroy(), c.showLoading(k, l), f(k)
            }
        ...
        function h(h) {
            ...
            function n(b, c) {
                ...
                return u = d.isFunction(b) ? b() : b, u.then(function (a) {
                    var b = a;
                    if (v.options.sAjaxDataProp)for (var d = v.options.sAjaxDataProp.split("."); d.length;) {
                        var f = d.shift();
                        f in b && (b = b[f])
                    }
            ...
            var q, r, s, t, u = null, v = Object.create(e);
    ...
    function r(a, b, c, e, f, g) {
        function h(h) {
            function i(b, c) {
                p = b, q = c;
                var e = a.defer(), h = g.newDTInstance(r);
