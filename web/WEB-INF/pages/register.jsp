...
<div class="courses_box1">
    <div class="container">
        <form class="login">
            ...
            <div class="form-group">
                <input type="text" autocomplete="off" class="required form-control" placeholder="Username *"
                       name="username" value="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="password" class="required form-control" placeholder="Conform Password *"
            ...
            <div class="form-group">
                <input type="text" autocomplete="off" class="required form-control" placeholder="Conform Email *"
                       name="conform email" value="">
            </div>
            <div class="form-group">
