...
<html>
<head>
    <title>Learn an Education Category Flat Bootstarp Resposive Website Template | Course_detail :: w3layouts</title>
    ...
    <div class="container">
        ...
        <div class="breadcrumb1">
            <ul>
                ...
                <li class="current-page"><a href="courses.html">Courses</a> with Course_detail</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="personBox">
                ...
                <div class="person_description">
                    <p>
                        ...
                        foresee the pain and trouble <a href="#">More..</a>
                    </p>
                </div>
            </div>
                        ...
                        <li>
                            <div class="banner-info1">
                                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh
                                    euismod tincidunt ut laoreet dolore magna aliquam erat quis nostrud.</p>
                        ...
                        <li>
                            <div class="banner-info1">
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                    suffered alteration in some form, by injected humour, content of a page.</p>
                        ...
                        <li>
                            <div class="banner-info1">
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page when looking at its layout. The point of usin but the
                                    majority.</p>
        ...
        <div class="col-md-9 detail">
                        ...
                        <h4 class="panel-title">
                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                               aria-expanded="true" aria-controls="collapseOne">
                                <i class="fa fa-bookmark-o icon_3"></i>voluptatem accusantium doloremque
                            </a>
                        </h4>
                    </div>
                        ...
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                               href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                <i class="fa fa-pencil-square-o icon_3"></i> At vero eos et accusamus
                            </a>
                        </h4>
                    </div>
                        ...
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                               href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                <i class="fa fa-comments-o icon_3"></i> quam nihil molestiae
                            </a>
                        </h4>
                    </div>
                        ...
                        <h4 class="panel-title">
                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                               href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                <i class="fa fa-clock-o icon_3"></i> Sed ut perspiciatis unde
                            </a>
                        </h4>
                    </div>
            ...
            <div class="author-box">
                ...
                <div class="author-box-right">
                    ...
                    <p>Lorem ipsum doldor sit amet, consectetur adeipiscing elit, sed do eiusmod temdpor incididuent ut
                        labore et doelore magna aliqua.. Lorem ipsum doldor sit amet, consectetur adeipiscing elit, sed
                        do eiusmod temdpor incididuent ut labore et doelore magna aliqua..</p>
                </div>
                <div class="clearfix"></div>
            </div>
            <div class="comment_section">
                ...
                <ul class="comment-list">
                    <li>
                        <div class="author-box">
                            ...
                            <div class="author-box_right">
                                <h5><a href="#">Admin</a><span class="pull-right"><a class="comment-reply-link"
                    ...
                    <li>
                        <div class="author-box">
                            <div class="author-box_left"><img src="images/author.png" class="img-responsive" alt=""/>
                            </div>
                            <div class="author-box_right">
                                <h5><a href="#">Admin</a><span class="pull-right"><a class="comment-reply-link"
                                                                                     href="#">Reply</a></span></h5>
                    ...
                    <ul class="children">
                        <li>
                            <div class="author-box">
                                <div class="author-box_left"><img src="images/author.png" class="img-responsive"
                                                                  alt=""/></div>
                                <div class="author-box_right">
                                    <h5><a href="#">Admin</a><span class="pull-right"><a class="comment-reply-link"
                                                                                         href="#">Reply</a></span></h5>
            ...
            <form class="comment-form">
                ...
                <div class="col-md-6 comment-form-right">
                    <textarea name="comment" aria-required="true" id="comment" class="form-control"
                              placeholder="Comment"></textarea>
                </div>
                <div class="clearfix"></div>
                <div class="form-submit">
                    <input name="submit" type="submit" id="submit" class="submit_1 btn btn-primary btn-block"
                           value="Add comment">
                </div>
            </form>
        </div>
